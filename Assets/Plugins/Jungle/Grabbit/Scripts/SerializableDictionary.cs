...
namespace Grabbit
{
    ...
    public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        ...
        public bool Remove(TKey key)
        {
            ...
            keys.Remove(key);
            // index >= 0 (not > 0): when the key is the first entry, its value at index 0 must still be
            // removed — the old guard skipped it, desyncing the parallel keys/values lists.
